...
class EvaluationHandler {
  ...
  private var timeNow: Long = 0.0l
  var selectedPath = ""
  var selectedPathEnergy = 0.0
  var selectedPathOverhead = 0.0
  var overallPlacementOverhead = 0.0
  private var output = ""
  private var algorithmEnum = 0
  private var predictionInvolved = false
  private var predictionGranularity = ""
  private var startTime: Long = 0.0l
  private var endTime: Long = 0.0l
  private var timeOffset:Long = 0.0l
  var runID = 0
  private var startTime_OpTreeCreation: Long = 0.0l
  private var endTime_OpTreeCreation: Long = 0.0l
  private var timeOffset_OpTreeCreation: Long = 0.0l
  private var startTime_NodeDiscovery: Long = 0.0l
  private var endTime_NodeDiscovery: Long = 0.0l
  private var timeOffset_NodeDiscovery: Long = 0.0l
  private var startTime_Placement_Deployment: Long = 0.0l
  private var endTime_Placement_Deployment: Long = 0.0l
  private var timeOffset_Placement_Deployment: Long = 0.0l
