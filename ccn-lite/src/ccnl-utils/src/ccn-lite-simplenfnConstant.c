...
main(int argc, char *argv[])
{
    ...
    int len, opt, cnt, sock = 0, socksize, suite = CCNL_SUITE_DEFAULT, port;
        ...
        switch (opt) {
            ...
            usage:
                fprintf(stderr, "usage: %s [options] NFNexpr\n"
                                ...
                                "Examples:\n"
                                "%% ccn-lite-simplenfnConstant /ndn/edu/wustl/ping\n"
                                "%% ccn-lite-simplenfnConstant \"echo hello world\"\n"
                                "%% ccn-lite-simplenfnConstant \"translate 'ccnx2014 /ccnx/parc/info.txt\"\n"
                                "%% ccn-lite-simplenfnConstant \"add 1 1\"\n"
                                "%% ccn-lite-simplenfnConstant -n \"/test/data\" \"@x (call 2 /func/f1 x)\"\n",
                        argv[0]);
                exit(1);
        }
    }
