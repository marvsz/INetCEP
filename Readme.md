...
For more Information about the Kernel Version read the [Readme](ccn-lite/doc/README-kernel.md).
...
# Extensions
Our Extensions and additions to ccn-lite and nfn-scala are described [here](Extensions.md).
# Evaluation
All scripts for evaluation are located in the [Evaluation Thesis](Evaluation_Thesis) Folder. The Readme that explains everything is located [here](Evaluation_Thesis/README.md).