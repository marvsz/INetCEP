...
$CCNL_HOME/bin/ccn-lite-relay -v trace -u 9007 -x /tmp/mgmt-nfn-relay-g.sock &
sleep 0.1
...
#----------------------------|
#9007 -> 9001
	FACEID=`$CCNL_HOME/bin/ccn-lite-ctrl -x /tmp/mgmt-nfn-relay-g.sock newUDPface any ${VMS[5]} 9006 \
