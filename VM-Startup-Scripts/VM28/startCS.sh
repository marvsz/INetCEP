...
java -jar "$NODE_A"/nfn-assembly-0.2.2.jar --mgmtsocket /tmp/mgmt-nfn-relay-a.sock --ccnl-addr "$IP" --ccnl-port 9001 --cs-port 9011 --debug --ccnl-already-running /node/nodeA
